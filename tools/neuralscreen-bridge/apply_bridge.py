...
patch(CPP,
      ...
      lines("// DLSS 5 SUITE: set when SUITE runs this worker.",
            ...
            "    const HWND above = GetWindow(g_wgc_hwnd, GW_HWNDPREV);",
            "    if (above == g_present_hwnd) return;",
            "    const bool aboveIsTopmost = above != nullptr && (GetWindowLongPtrW(above, GWL_EXSTYLE) & WS_EX_TOPMOST) != 0;",
            "    SetWindowPos(g_present_hwnd, (above == nullptr || aboveIsTopmost) ? HWND_TOP : above, 0, 0, 0, 0,",
